database =  {"Rosa":4, "Calla":1.5, "Tulipano":3, "Giglio":3, "Gerbera":1.20, "Margherita":1, "Orchidea":7, "Girasole":4, "Viola":2, "Papavero":0.50,
"Ginestra":0.2, "Crisantemo":0.7, "arancio":0.3,  "Fiordaliso":2.5, "Calendula":1, "Lavanda":0.3, "Non ti scordar di me":0.2, "Ortensia":2, "Peonia":1.5, "Mimosa":3,"Giacinti":8,
...
"Zimnia":1.5,"Eucalipto":0.6,"Amaryllis":1.6,"Fresie":1,"Camelia":0.80}
...
database3={'uno':1,'una':1,'due':2,'tre':3,'quattro':4,'cinque':5,'sei':6,'sette':7,'otto':8,'nome':9,'dieci':10,'undici':11,'dodici':12,'tredici':13,'quattordici':14,
...
Richieste = {
    ...
    '8': ["([a-z])?(mazzo di|mazzetto di|mazzo con|vorrei|voglio)([a-z])?"],
    '9': ["([a-z])?(avete|ci sono|vendete)([a-z])?"],
    '10':["([a-z])?(sconto|sconticino)([a-z])?"]
...
Risposte = {
    ...
    '8': [""],
    '9': [""],
    '10' : ["No mi spiace non posso fare sconti"],
    'fiori':[]
    #'saluto': ["Arrivederci"]
}
